...
| **FR-04** (Win Detection) | ADR-001, ADR-007 | `WinDetector` Domain Service, `GameCompleted` event | `WinDetector_DetectsAllRowsColumnsDiagonals` | Unit Test | Deferred to P005 |
| **FR-05** (Draw Detection) | ADR-001, ADR-007 | `WinDetector` Domain Service, `GameCompleted` event | `MakeMove_FullBoardNoWinner_TransitionsToDraw` | Unit Test | Deferred to P005 |
