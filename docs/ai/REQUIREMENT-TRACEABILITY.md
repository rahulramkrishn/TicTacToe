...
| **FR-10** (Computer Undo) | ADR-004, Memento | `GameMemento`, `Game.MakeMove` (pair boundary), `Game.Undo()` | `GameUndoTests.Undo_InComputerMode_RevertsHumanAndComputerPair` | Unit Test | Memento logical-boundary mechanism established in P006; full Computer Mode pair-level integration deferred to P007. |
